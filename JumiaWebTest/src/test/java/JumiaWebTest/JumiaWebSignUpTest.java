...
public class JumiaWebSignUpTest {
    ...
    public void setup () throws InterruptedException {
        ...
        public void signup () throws InterruptedException {
            ...
            driver.findElement(By.id("fi-firstName")).sendKeys("userFirstnName");

            //input last name in the last name field
            driver.findElement(By.id("fi-lastName")).sendKeys("userLastName");

            //input email in the email field
            driver.findElement(By.id("fi-email")).sendKeys("userEmail");

            //input password in the password field
            driver.findElement(By.id("fi-password")).sendKeys("userPassword");
